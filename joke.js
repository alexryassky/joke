		...
		if (collResult.indexOf('ANOTHER_OBJECT') != -1) {
			if (!context) {
				...
				for (i = 0; i < this.collideWith.length; i++) {
					var obj = context[this.collideWith[i]], right = obj.x + obj.width, left = obj.x, top = obj.y, bottom = obj.y + obj.height;
...
var Scene = function (RootObj) {
	...
	spritesSheet.loadFromFile('resources/walking_sprites_tr.png');
	document.body.appendChild(spritesSheet.image);
...
Interface = {
	...
	var o2 = new sceneObject(320, 50, 28, 40);
	var o3 = new sceneObject(140, 40, 100, 20);
	var o4 = new angularMovingSceneObject(150, 100, 20, 20, 15);

	var behSpriteable = new setSpriteBehavior();
	behSpriteable.setOwner(o2);
	o2.colOffset =7;
	o1.color = '10,100,40';
	o2.color = '250,40,40';
	o3.color = '30,30,250';
